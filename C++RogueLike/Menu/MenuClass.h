...
private:
	...
	int menu_class_get_newOption() noexcept { return stateInt; }
	void menu_class_set_oldOption(int option) noexcept { oldOption = option; }
	void menu_class_set_newOption(int option) noexcept { stateInt = option; }
	...
	void menu_class_move_up() noexcept { stateInt--; currentState = static_cast<MenuClassOptions>(stateInt); }
	void menu_class_move_down() noexcept { stateInt++; currentState = static_cast<MenuClassOptions>(stateInt); }
