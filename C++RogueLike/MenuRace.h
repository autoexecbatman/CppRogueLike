...
private:
	...
	void menu_race_move_up() noexcept { newOption--; currentOption = static_cast<MenuRaceOptions>(newOption); }
	void menu_race_move_down() noexcept { newOption++; currentOption = static_cast<MenuRaceOptions>(newOption); }
