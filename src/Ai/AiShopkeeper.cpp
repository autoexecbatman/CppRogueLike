...
void AiShopkeeper::move_to_target(Actor& owner, Vector2D target, GameContext& ctx)
{
...
void AiShopkeeper::move_or_trade(Creature& shopkeeper, Vector2D target, GameContext& ctx)
{
